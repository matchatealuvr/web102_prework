...
function addGamesToPage(games) {
     ...
     // loop over each item in the data
        ...
        for (let i = 0; i < games.length; i++) {
            ...
            // set the inner HTML using a template literal to display info about the game
            gameCard.innerHTML = `
...
const unfundedExplanation = `Currently, there ${unfundedGamesCount === 1 ? 'is' : 'are'} ${unfundedGamesCount} unfunded game${unfundedGamesCount === 1 ? '' : 's'} on our platform.`;

// create a new DOM element containing the template string and append it to the description container
const unfundedExplanationElement = document.createElement("p");
unfundedExplanationElement.innerHTML = unfundedExplanation;
descriptionContainer.appendChild(unfundedExplanationElement);
/************************************************************************************
